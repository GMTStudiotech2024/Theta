...
export function AlertDemo() {
  return (
    <Alert className="bg-gradient-to-r from-[#FC210D] to-[#450A3B] border-0" >
      <Terminal className="h-4 w-4" />
      <AlertTitle className="text-slate-50">[⚠️New Update]</AlertTitle>
      <AlertDescription className="text-slate-50">
        New Update in <span className="text-yellow-300">Terms of Services</span>
      </AlertDescription>
    </Alert>
  )
}
